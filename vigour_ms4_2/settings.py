"""
Django settings for vigour_ms4_2 project.
...
CSRF_TRUSTED_ORIGINS = ['https://8000-lyseriuos-vigourms42-irjdkhedpsn.ws-eu45.gitpod.io/']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media',  # for items without image
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'lyseriuos-vigour-ms4-2'
...
DEFAULT_FROM_EMAIL = 'info@vigour.com'
