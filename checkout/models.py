...
# Use the information they put into the payment form to create an order instance.
...
class OrderLineItem(models.Model):
    ...
    product_size = models.CharField(max_length=2, null=True, blank=True)  # 2kg, 3kg, 4kg, 5kg, 6kg
