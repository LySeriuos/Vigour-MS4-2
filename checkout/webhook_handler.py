...
class StripeWH_Handler:
    ...
    # _send starts with this underscore because it will be used only in this class
    def _send_confirmation_email(self, order):
        ...
        print(body)
        # call this anywhere is need to send email
        send_mail(
            subject,
            body,
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if order_exists:
            # order was created by the form at this stage
            # send conf email before response to the stripe
        ...
        # and if it doesn't exists it will create new one
            ...
            try:
                ...
                return HttpResponse(
                    ...
                    status=500)
        # after webhook_handler created order send conf email
        self._send_confirmation_email(order)
        return HttpResponse(
            content=f'Webhook received: {event["type"]} | SUCCESS:' 
